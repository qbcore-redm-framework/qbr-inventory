...
AddEventHandler("inventory:client:CheckWeapon", function(weaponName)
    ...
    if currentWeapon == weaponName then
        ...
        Citizen.InvokeNative(0xADF692B254977C0C, ped, GetHashKey("WEAPON_UNARMED"), true)
...
AddEventHandler("inventory:client:AddDropItem", function(dropId, player, coords)
    ...
    while not HasModelLoaded( GetHashKey("p_cs_lootsack02x") ) do
        Wait(500)
        modelrequest( GetHashKey("p_cs_lootsack02x") )
    end
    ...
    SetModelAsNoLongerNeeded(GetHashKey("p_cs_lootsack02x"))
    Drops[dropId] = {
        id = dropId,
        coords = {
            x = x,
...
AddEventHandler("inventory:client:RemoveDropItem", function(dropId, obj)
    Drops[dropId] = nil
end)
